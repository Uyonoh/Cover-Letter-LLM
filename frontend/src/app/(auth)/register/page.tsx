...
function Register() {
  ...
  return (
    <form
      action=""
      className="form-container flex flex-col justify-center items-between gap-5 px-5"
    >
      <div className="text-center flex flex-col gap-2">
        <h1 className="font-bold text-2xl">Register a new account</h1>
        <p>
          Already hasve an account?{" "}
      ...
      <div className="flex flex-col gap-4 text-secondary w-full sm:w-[500px]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start gap-2 sm:gap-4 text-sm">
          <div className="flex items-start gap-2">
            ...
            />
            <label htmlFor="consent" className="text-white/80 leading-snug">
              I agree to the{" "}
              <Link
