        ...
        <div className="flex flex-col w-full py-5 px-5 sm:px-7 md:px-10">
            ...
            <section className="personal py-5 pb-10 border-b border-secondary">
                ...
                <div className="sm:grid grid-cols-2 gap-5 py-2 text-secondary">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <input type="text" name="job-title" className="form-input" placeholder="eg. Software Engineer"/>
                    </div>

                    <div className="flex flex-col gap-2">
                        <label htmlFor="location">Location</label>
                        <input type="text" name="location" className="form-input" placeholder="eg. San Francisco, CA"/>
                    </div>
                </div>
            </section>
                ...
                <div className="flex flex-col sm:grid sm:grid-cols-2 gap-7 py-2">
                    ...
                    <div className="notifications col-start-1 flex justify-between px-2 items center">
                            ...
                            <div className="flex items-center">
                                <input type="checkbox" name="email-notifications" id="email-notifications" className="peer sr-only" />
                                <label htmlFor="email-notifications" className="relative flex w-11 h-6 cursor-pointer rounded-full bg-gray-300 transition-colors duration-300 peer-checked:bg-primary after:absolute after:left-1 after:top-1 after:h-4 after:w-4 after:rounded-full after:bg-white after:transition-transform after:duration-300 peer-checked:after:translate-x-5"></label>
                            </div>
                    </div>
            ...
            <section className="subscription py-5 pb-10 border-b border-secondary">
                ...
                <div className="flex flex-1 flex-col px-2 py-2 gap-3">
                    <p>You are on the <span className="text-primary">Free</span> plan.
                        Upgrade to unlock more features.
                    </p>
                    <button className="bg-primary/90 text-white px-4 py-2 max-w-[130px] rounded-lg cursor-pointer">Upgrade Plan</button>
                </div>
            </section>
            ...
            <section className="data-privacy py-5 pb-10 border-b border-secondary">
                ...
                <div className="flex justify-between py-2">
                    ...
                    <button className="bg-primary/30 text-primary rounded-lg w-20 h-10 cursor-pointer">Manage</button>
                </div>
            </section>
